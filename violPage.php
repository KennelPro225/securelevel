...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $sql = "INSERT INTO viols (titre, nbrevictimes,nbrenfants,nbrfemmes,nbrhommes,lieu,source,typeviol,dateEvenement,datepost)
        ...
        <div class="secondaire">
            ...
            <div class="trois">
                ...
                <div class="fond_blanc">
                    <div class="text-form">
                        <h2>enregistrement de cas de viol</h2>
