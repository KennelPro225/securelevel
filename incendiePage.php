...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $sql = "INSERT INTO incendies (titre, nbrevictimes,nbrenfants,nbrfemmes,nbrhommes,lieu,source,typeIncendie,dateEvenement,datepost)
                ...
                <div class="fond_blanc">
                    ...
                    <form action="" method='post'>
                        <div class="first_template">
                            ...
                            <fieldset>
                                <legend>Type d'incendie</legend>
                                <select name="type" id="type">
                                    <option value="">Type d'incendie</option>
