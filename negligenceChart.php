...
if (isset($recherche)) {
    if (($lieu != 0) && ($annee != 0)) {
        for ($mois = 1; $mois <= 12; $mois++) {
            $info = $db->prepare("SELECT COUNT(*) AS nbMed FROM negligences_medicales INNER JOIN ville ON lieu = id WHERE MONTH(dateEvenement) = $mois AND YEAR((dateEvenement)=$annee) AND(lieu =$lieu)");
            $info->execute();
        ...
        <div class="secondaire">
            ...
            <div class="trois">
                ...
                <div class="fond_blanc">
                    <div class="text-form">
                        <h2>Statistiques des cas de Negligence Medicale</h2>
