...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $sql = "INSERT INTO inondations (titre, nbrevictimes,nbrenfants,nbrfemmes,nbrhommes,lieu,source,dateEvenement,datepost)
    VALUES ('$titre','$nbrevictimes','$nbrenfants','$nbrefemmes','$nbrehommes','$lieu','$source','$date','$now')";
...
<head>
    ...
    <title>Formulaire-Inondation</title>
</head>
        ...
        <div class="secondaire">
            ...
            <div class="trois">
                ...
                <div class="fond_blanc">
                    <div class="text-form">
                        <h2>enregistrement de cas d’Inondation</h2>
