...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $sql = "INSERT INTO negligences_medicales (titre, nbrevictimes,nbrenfants,nbrfemmes,nbrhommes,lieu,source,type,dateEvenement,datepost)
...
<head>
    ...
    <title>Formulaire-Negligence Medicale</title>
</head>
        ...
        <div class="secondaire">
            ...
            <div class="trois">
                ...
                <div class="fond_blanc">
                    <div class="text-form">
                        <h2>enregistrement de cas de negligence medicale</h2>
