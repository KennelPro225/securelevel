...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $sql = "INSERT INTO accidents (titre, nbrevictimes,nbrenfants,nbrfemmes,nbrhommes,lieu,source,engins,dateEvenement,datepost)
            VALUES ('$titre','$nbrevictimes','$nbrenfants','$nbrefemmes','$nbrehommes','$lieu','$source','$engin','$date','$now')";
                        ...
                        <div class="first_template">
                            <fieldset class="dateItem">
                                ...
                                <div id="datetime">
                                    <div>
                                        <fieldset>
                                            <input type="number" name="mois" id="mois" placeholder="MM" min="1" max="12" onchange="handleChange()" oninput="handleInput()">
                                        </fieldset>
                                    </div>
                                    <div>
                                        <fieldset id="day">
                                            <input type="number" name="jour" id="jour" placeholder="DD" min="1" max="31" onchange="handleChange()" oninput="handleInput()">
                                        </fieldset>
                                    </div>
                                    <div>
                                        <fieldset id="year">
                                            <input type="number" name="annee" id="annee" placeholder="YYYY" min="2000" max="2022" onchange="handleChange()" oninput="handleInput()">
                                        </fieldset>
                                    </div>
                                </div>
                            </fieldset>
