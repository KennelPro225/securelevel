...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    //   }
    $sql = "INSERT INTO suicides (titre, nbrevictimes,nbrenfants,nbrfemmes,nbrhommes,lieu,source,typesuicide,dateEvenement,datepost)
...
<head>
    ...
    <title>Formulaire-Suicide</title>
</head>
        ...
        <div class="secondaire">
            ...
            <div class="trois">
                ...
                <div class="fond_blanc">
                    <div class="text-form">
                        <h2>enregistrement de cas de suicide</h2>
                        ...
                        <div class="first_template">
                            ...
                            <fieldset>
                                ...
                                <select name="type" id="type">
                                    <option value="">Type de viol</option>
